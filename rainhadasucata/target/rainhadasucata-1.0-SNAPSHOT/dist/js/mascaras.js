        ...
        mask: {
            ...
            set: function (el, options) {
                ...
                return $el.each(function () {
                    ...
                    if (options.attr)
                        maskObj.options.attr = options.attr;
                    ...
                    if (maskObj.masks[tmpMask])
                        o = $.extend(o, maskObj.masks[tmpMask]);
                    ...
                    if (o.mask != null) {
                        ...
                        if ((o.type == 'fixed' || reverse) && o.setSize && !$this.attr('size'))
            ...
            string: function (str, options) {
                ...
                switch (typeof options) {
                    case 'string':
                        // then we see if it's a defined mask	
                        if (this.masks[options])
                            o = $.extend(o, this.masks[options]);
                        else
                            o.mask = options;
                        break;
                    case 'object':
