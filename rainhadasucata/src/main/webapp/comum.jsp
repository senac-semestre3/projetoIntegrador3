        ...
        <div class="row">
            <div class="container-menu-lateral col s2 m3 l2 ">
                ...
                <ul class="collapsible">
                    ...
                    <li class="btn-menu"><a href="#" class="collapsible-header waves-effect waves-light"><i class="fa fa-user-o" aria-hidden="true"></i>Clientes</a></li>
                    <li class="btn-menu"><a href="#" class="collapsible-header waves-effect waves-light"><i class="fa fa-barcode" aria-hidden="true"></i>Produtos</a></li>
                    <li class="btn-menu"><a href="#" class="collapsible-header waves-effect waves-light"><i class="fa fa-usd" aria-hidden="true"></i>Vendas</a></li>
                    <li class="btn-menu"><a href="#" class="collapsible-header waves-effect waves-light"><i class="fa fa-line-chart" aria-hidden="true"></i>Relatórios</a></li>
                    <ul class="collapsible">
